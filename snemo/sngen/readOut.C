...
void readOut(){
	...
	myTree->AddFile("p=(mu-)-E=4000MeV-v=1250-rCell=2.20-he_90_Ib_10.gas-5clusters.root");
	...
	Double_t dhit[100], thit[100], integral[100], gain[100];
	Int_t nclu, irow, icol;
	Int_t nelec[100];
...
//	TProfile *hprof = new TProfile("hprof","Drift histogram",50,0,7000,0,4.5);
...
////	TF1 *func = new TF1("func","(((x/1000)*[0])/((pow((x/1000),[1]))+[2]))",1000,5000);
////	func->SetParameters(2.3997,0.7731,0.3347);
////	hprof->Fit("func","","",1000,5000);
//
//	hprof->Draw();
//
//	TLegend *hleg = new TLegend(0.6,0.1,0.9,0.4);
//	hleg->AddEntry("","A = 1.139","");
//	hleg->AddEntry("","B = 5.300","");
//	hleg->AddEntry("","C = -9.992","");
//	hleg->Draw();
