...
//		if(itrk%10==0)
		...
		b = gRandom->Uniform(XWallGap,XWallGap+rCell);
		//phi=gRandom->Uniform(0,TMath::TwoPi());
		phi=gRandom->Uniform((3*(TMath::PiOver2()))-0.278,3*(TMath::PiOver2()));
		theta=TMath::PiOver2();
  ...
  for(irow=0; irow<nrows; irow++){
	  ...
	  Tracking->NewTrack(b,0,0, //Position
						 0.,                   //Time
